...
|---|---|---|---:|---:|---|---:|---:|---:|---|
| baseline_emb64_mse | train_simpleCNN_baseline.json | SimpleCNN_Baseline | 64 | 1 | MSELoss | 80000 | 20000 | 0.1771 | baseline |
| pool1_emb128_mse | train_simpleCNN_pool.json | SimpleCNN_Pool | 128 | 1 | MSELoss | 80000 | 20000 | 0.1785 | Embedding size increased|