...
class CoverageEvaluator:
    ...
    def evaluate_intervals(
        ...
        """
        Evaluate empirical coverage, interval widths, bin-wise metrics,
        normal approximation tolerance bands, and binomial undercoverage tests.
        ...
        # Defensive handling for asymmetric intervals.
        ...
        # Normal approximation tolerance bands centered on the nominal CL.
        ...
        # Binomial p-values for undercoverage.
    ...
    def normal_tolerance_bands_nominal(
        ...
        This answers:
        If the true coverage were confidence_level, what empirical coverage
